...
let MULTIPLIER = 1.92;
let MY_ENTRIES = [0];
let INVESTMENT_VALUE = 200000
let PROFIT_VALUE_LIMIT = 50

for (let i = start; i < INVESTMENT_VALUE; i++) {
...
//   console.log(">>>",isAllowedAsGoodEntrie);
  ...
  if (isAllowedAsGoodEntrie >= PROFIT_VALUE_LIMIT) {
    console.log(MY_ENTRIES.length,"º --- " ,actualStartValue, "-", earns, ">", profit, "|", isAllowedAsGoodEntrie, ">>>> ",totalOfLosses );
